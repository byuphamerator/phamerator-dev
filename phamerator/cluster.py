...
def genmatrix(list, combinfunc, symmetric=True, diagonal=0):
   """
      ...
      while len(matrix) > 2 or matrix == []:
         ...
         for row in matrix:
            ...
            for cell in row:
               ...
               #print 'cell:', cell, 'row:', row, 'rowindex:', rowindex, 'cellindex:', cellindex, 'mindistance:', mindistance, 'smallestpair:', smallestpair
               #print 'cell is', type(cell), 'and mindistance is', type(mindistance)
               #print 'rowindex != cellindex', rowindex != cellindex
               #print 'cell < mindistance', cell < mindistance
               #print 'smallestpair is None', smallestpair is None
         ...
         print 'size of _data:', len(self._data)
