...
def main():
  ...
  c =         db_conf.db_conf(username=username, password=password, db=database, server=server).get_cursor()
  csrCursor = db_conf.db_conf(username=username, password=password, db=database, server=server).get_cursor()
